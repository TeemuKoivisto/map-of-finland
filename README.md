...
Using QGIS (I had version 2.18.20) you can open both layers at the same time and then use `Vector -> Geoprocessing Tools -> Clip` and cut the latest municipalities with the old borders. Now what you get should be the current municipalities with coastline borders.
